    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: 420, padding: '0 24px', position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          ...
          <h1 style={{ fontSize: 26, fontWeight: 800, color: 'var(--text-primary)' }}>Janta Kapad Bhandar</h1>
          <p style={{ color: 'var(--text-muted)', fontSize: 13, marginTop: 4 }}>ERP — Business Management System</p>
        </div>
        ...
        <div style={{
          ...
          <form onSubmit={handleSubmit} autoComplete="on">
            ...
            <button
              ...
              disabled={loading}
              style={{ justifyContent: 'center', padding: '14px 24px', fontSize: 15, fontWeight: 700 }}
            >
              {loading
        ...
        <p style={{ textAlign: 'center', fontSize: 12, color: 'var(--text-muted)', marginTop: 24 }}>
          © 2026 Janta Kapad Bhandar · Secured by Firebase · 24×7 Online
        </p>
      </div>
    </div>
  )
